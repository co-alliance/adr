  ...
  <div id="header-bar">
    <header role="banner" class="grid-container banner" style="max-width:<?php print $thegrid; ?>">
      <div class="grid-25 logo-wrapper header-grid">
        <div id="brand">
          <div id="logo">
            <a href="http://www.uwyo.edu"><img class="logouw" src="http://uwyo.coalliance.org/sites/all/themes/gratis/images/uwlogosmgold.png" alt="University of Wyoming logo" title="University of Wyoming" width="90" height="43" /></a>
            <?php if ($logo): ?>
    ...
    <div class="grid-100">
      <section id="main-menu" role="navigation">
        ...
        <a class="menu-link" href="#menu">
         <i class="icon-fixed-width menu-icon fa fa-foo">&#xf13a;</i>
        </a>
